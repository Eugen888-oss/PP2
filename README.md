...
<details>
    ...
    The $ makes the return_value to an identifier, in which the calculation is saved. Without the $ the echo comand just give back what we write, in this case the word return_value.
</details>
...
<details>
    ...
    ![image](https://github.com/user-attachments/assets/673a7a29-468c-4066-b8a3-1dcbd26b832d)
